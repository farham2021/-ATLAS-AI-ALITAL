...
def _v3_rows(kind,limit=300):
    # Multi-asset read path: merge canonical + Data Plane tables.  This is
    # read-only and deliberately does not alter any HOURLY/DEEP4H/DAILY16/
    # NIGHTLY23 scheduling or delivery semantics.
    if not STORE.enabled:return []
    tabs={
